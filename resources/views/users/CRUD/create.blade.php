<x-layout>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Add New User</h2>
                <p class="mt-2 text-sm text-gray-600">
                    Create a new user account by filling in the form below.
                </p>
            </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}"
                               class="mt-1 block w-full border-gray-300 rounded-md p-3 border @error('name') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}"
                               class="mt-1 block w-full border-gray-300 rounded-md p-3 border @error('email') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password"
                               class="mt-1 block w-full border-gray-300 rounded-md p-3 border @error('password') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation"
                               class="mt-1 block w-full border-gray-300 rounded-md p-3 border"
                               placeholder="••••••••" required>
                    </div>
